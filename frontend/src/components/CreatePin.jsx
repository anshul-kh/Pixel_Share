    ...
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      ...
      <div className='flex flex-col  justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
                ...
                <label >
                  <div className='flex flex-col items-center justify-center h-full'>
                    ...
                    <p className='mt-32 text-gray-400 '>
                     Use High Quality JPG , SVG, PNG of less than 20MB
                    </p>
                  </div>
                  ...
                  '>
                    <img src={imageAsset?.url} alt="uploaded-fig" className='h-full w-full' />
                    <button
                      type='button'
                      className='absolute bottom-3 right-3 p-3 rounded-full bg-white cursor-pointer outline-none text-xl hover:shadow-md transition-all duration-500 ease-in-out'
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full '>
          ...
          }} placeholder='Enter the Title' className='outline-none text-2xl sm:text-3xl font-bold border-b-2 border-gray-200 p-2 ' />
          {
            user && (
          ...
          <input type='text' value={about} onChange={(e) => {
            setAbout(e.target.value)
          }} placeholder='Give Some Description' className='outline-none text-base sm:text-lg  border-b-2 border-gray-200 p-2 ' />
          ...
          <div className='flex flex-col '>
            <div>
              ...
              }} className='outline-none w-4/5 border-b-2 text-base p-2 rounded-md border-gray-200 cursor-pointer'>
